<template>
  <div
    ...
    style="width: 250px; background: linear-gradient(135deg, #1f2d3d 0%, #198754 100%)"
  >
    <!-- Perfil -->
    ...
    <nav class="flex-grow-1">
      <router-link to="/Coordinador" class="nav-link text-white py-2 px-3 rounded mb-1">
        Inicio
      </router-link>
      ...
      <div class="gestion-dropdown mb-1">
        ...
        <div v-show="showGestion" class="submenu mt-1">
          ...
          <router-link
            class="dropdown-item"
            to="/Coordinador/Gestion Centros"
            active-class="bg-secondary"
            >Centros</router-link
          >
          <router-link
            class="dropdown-item"
            to="/Coordinador/Gestion Lab"
            active-class="bg-secondary"
            >Laboratorios</router-link
          >
          <router-link
            class="dropdown-item"
            to="/Coordinador/Gestion Provedores"
            active-class="bg-secondary"
